class Footer extends HTMLElement {
  ...
  connectedCallback() {
    this.innerHTML = `
<section id="contact" class="accent-bg">
    <div class="contact-inner wrapper">
      ...
      <div>
        ...
        <div class="contact-social">
          <a class="linkedin-icon" rel="noopener" href="https://www.linkedin.com/in/kevinabouhanna/" target="_blank">
          ...
          <a class="github-icon" rel="noopener" href="https://github.com/kevinabouhanna" target="_blank">
